...
for line in reader:
    cmd = '/py/cleos_3 -u http://dns2-rpc.oraclechain.io:58888 --wallet-url http://127.0.0.1:8900 push action eosadddddddd transfer \'["eosadddddddd","{}","0.0001 ADD","EOS TPS 1ST TEST FROM EOS ADD/BPC:eosadddddddd"]\' -p eosadddddddd'.format(line[0], line[1])
