...
for line in reader:
    cmd = '/py/cleos_4 -u http://api.eos.store:80 --wallet-url http://127.0.0.1:8900 push action eosadddddddd transfer \'["eosadddddddd","{}","0.0001 ADD","EOS TPS 1ST TEST FROM EOS ADD/BPC:eosadddddddd"]\' -p eosadddddddd -f'.format(line[0], line[1])
